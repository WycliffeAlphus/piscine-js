...
export const getActive = () => {
    ...
    const nonClassical = document.querySelectorAll('body > .classical :not(.active)')
    return [active, nonClassical]
}

export const getBonannoPisano = () => {
    const bonano = document.querySelectorAll('body #BonannoPisano')
    const notBonano = document.querySelectorAll('body > .classical.active)')
